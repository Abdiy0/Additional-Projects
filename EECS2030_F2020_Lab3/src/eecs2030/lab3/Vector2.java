...
public final class Vector2 {
	...
	public static Vector2 multiply(double s, Vector2 a) {
		double v = s * a.x;
		double c = s * a.y;
		Vector2 n = new Vector2(v, c);
		return new Vector2(v,c);
	}
	...
	public static Vector2 dirVector(double theta) {
		...
		Vector2 n = new Vector2(Math.cos(rad), Math.sin(rad));
		return n;
	...
	public String toString() {
		...
		return "This vector has a x compoent of " + this.x + " a y componet of " + this.y;
